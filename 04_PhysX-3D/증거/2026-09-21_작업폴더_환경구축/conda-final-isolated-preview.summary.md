...
- 실제 solver 출력: conda-final-isolated-preview.json (`원본 로컬 참조: conda-final-isolated-preview.json`)
- stderr: conda-final-isolated-preview.stderr.log (`원본 로컬 참조: conda-final-isolated-preview.stderr.log`)
- 실행 시작/종료 및 exit code: conda-final-isolated-preview.execution.log (`원본 로컬 참조: conda-final-isolated-preview.execution.log`)
- 실행 전 상태: conda-final-isolated-preview.before.json (`원본 로컬 참조: conda-final-isolated-preview.before.json`)
